...
public class AWSV4AuthTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(testOperation.getAuthorizationString(is,"20200121T123154Z","ABC","123","us-east-1","lambda", "POST", "lambda.us-east-1.amazonaws.com" ,"/2015-03-31/functions/helloLambda/invocations","test=1"));
